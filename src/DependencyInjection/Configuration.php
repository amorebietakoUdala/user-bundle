    ...
    public function getConfigTreeBuilder(): \Symfony\Component\Config\Definition\Builder\TreeBuilder
    {
        ...
        $rootNode
            ->children()
                ...
                ->scalarNode('ldap_user')->defaultValue(null)->info('The user that will search in the LDAP')->end()
                ->scalarNode('ldap_password')->defaultValue(null)->info('The password of the user that will search in the LDAP')->end()
            ->end();
